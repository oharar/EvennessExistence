...
Now we fit the Poisson lognormal disrtibution, CEGS ("compound exponential-geometric series distribution"), and negtive binomial: these are all zero truncated. From these we return the patameter estimates and estimates of species richness.
